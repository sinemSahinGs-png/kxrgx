export const aboutCopy = {
  tr: `7 yılı aşkın deneyime sahip bir müzik prodüktörü ve ses tasarımcısıyım.

Müzik yolculuğum 15 yaşında davul çalarak başladı; underground kulüplerdeki DJ performanslarıyla devam etti ve zamanla tam zamanlı müzik prodüksiyonuna dönüştü.
...
My journey began at the age of 15 behind the drums, continued through DJ performances in underground clubs, and eventually evolved into full-time music production.
...
export const aboutTR = aboutCopy.tr;
/** @deprecated use aboutCopy */
export const aboutEN = aboutCopy.en;
